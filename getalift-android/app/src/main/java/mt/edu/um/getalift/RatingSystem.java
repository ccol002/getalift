...
public class RatingSystem extends AppCompatActivity {
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        if (intentRating != null) {
            targetID = intentRating.getIntExtra("ratedId",2);
            ...
            role = intentRating.getIntExtra("role",4);
            Log.i(TAG + "role ID",String.valueOf(role));
        }
    ...
    public void rateDriver(View view){
        ...
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
        // We get the URL of the server.
        String url = ConnectionManager.SERVER_URL+"/api/ratings/existingRate/Driver";
